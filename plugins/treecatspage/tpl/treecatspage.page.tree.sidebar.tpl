<!-- BEGIN: MAIN -->
<ul<!-- IF {LEVEL} == 0 --> class="nav flex-column small"<!-- ELSE --> class="nav flex-column small px-0"<!-- ENDIF -->>
	<!-- IF {LEVEL} == 0 -->
	<li class="nav-item">
		<div class="d-flex align-items-center px-3 my-2" title="{PHP.L.All}">
			<i class="fa-regular fa-folder me-2"></i>
			<span>{PHP.L.Pages} {PHP.L.All}</span>
